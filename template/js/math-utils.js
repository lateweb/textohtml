  ...
  function injectCSS() {
      ...
      if (!document.getElementById(styleId)) {
          ...
          style.textContent = `
              ...
              .tex-raw-block { display:block; white-space:pre-wrap; word-break:break-word; cursor:text; margin:0.5em 0; background: var(--bg-color); padding: 0.5em; border-radius: 4px; font-family: 'Fira Code', monospace; color: #d63384; font-size: 1.05em; }
              ...
              p + .math-scroll { margin-top: -0.5em; }
